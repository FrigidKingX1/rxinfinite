...
VERIFIED_TRACK_IDS: set[int] = {
    ...
    # Rallycross — each circuit has exactly one track model. Verified against
    # the game data enums; in-game testing recommended to confirm loading screens.
    131, 141, 142, 152, 153, 154, 158, 171, 172, 173, 174, 175, 176,
}
