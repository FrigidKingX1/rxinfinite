...
from .api_client import RXInfiniteClient
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--api-url", default=None,
                        help="Base URL for the rxinfinite.net web API "
                             "(e.g. https://rxinfinite.net). "
                             "When omitted, the server uses local fallback data.")
    parser.add_argument("--api-token", default=None,
                        help="Game API token (df_xxx) for authenticating with rxinfinite.net.")
    return parser
