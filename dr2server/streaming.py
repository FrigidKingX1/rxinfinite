...
files into a target directory (defaults to ~/rxinfinite/). OBS Text (GDI+)
...
overlays go clean when RXInfinite isn't running. The exit behavior is
...
class StreamingWriter:
    def __init__(
        ...
        self._output_dir: Path = Path.home() / "rxinfinite"
    ...
    def clear_files(self) -> None:
        ...
        when RXInfinite isn't running, rather than holding the last race's
