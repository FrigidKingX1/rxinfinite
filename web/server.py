...
log = logging.getLogger('rxinfinite')
log.info('rxinfinite server module loading')
...
MAIL_FROM = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@rxinfinite.com')
...
def send_verification_email(user: dict[str, Any]) -> bool:
    ...
    body = (
        ...
        f'Welcome to RXInfinite! Please verify your email address by visiting:\n\n'
        f'{link}\n\n'
        f'If you did not create this account, ignore this email.\n\n'
        f'- RXInfinite'
    )
    return _send_email(user['email'], 'Verify your RXInfinite account', body)
...
def send_reset_email(user: dict[str, Any]) -> bool:
    ...
    body = (
        f'Hi {user["display_name"]},\n\n'
        f'We received a request to reset your RXInfinite password. '
        f'Visit the link below to choose a new password:\n\n'
        f'{link}\n\n'
        f'This link expires in 1 hour. If you did not request this, ignore this email.\n\n'
        f'- RXInfinite'
    )
    return _send_email(user['email'], 'Reset your RXInfinite password', body)
...
def _send_invite_email(invitee: dict[str, Any], inviter: dict[str, Any],
    ...
    body = (
        ...
        f'join their club "{club["name"]}" on RXInfinite.\n\n'
...
CAR_CLASSES = {
    ...
    'RX Supercars': [
        ...
        'Ford Fiesta RX Mk8', 'Ford Fiesta RX Mk7', 'Subaru WRX STI RX',
    ],
    'RX Supercars 2019': [
        'Renault Megane RS RX 2019', 'Peugeot 208 WRX 2019',
        'Audi S1 EKS RX Quattro 2019', 'Renault Clio RS RX 2019',
        'Ford Fiesta RXS Evo 5 2019', 'Ford Fiesta RX Mk8 2019',
        'Mini Cooper SX1 2019', 'Ford Fiesta RX Stard 2019',
        'Seat Ibiza RX 2019',
    ],
    'RX Super 1600': [
        'Volkswagen Polo S1600', 'Renault Clio RS S1600',
    ...
    'Group B Rallycross': [
        'Lancia Delta S4 RX', 'Ford RS200 Evo',
        'Peugeot 205 T16 RX', 'MG Metro 6R4 RX',
    ],
    'Cross Kart': [
        'Speedcar Xtrem',
    ],
...
def _seed_users() -> list[dict[str, Any]]:
    ...
    for username, country, bio in profiles:
        u = create_user(
            username=username,
            email=f'{username.lower()}@rxinfinite.local',
            password='rally2025',
